...
#####################################
vulnimage - knqyf263/trivy-image:1.2.3
#####################################

EOS

crane copy knqyf263/trivy-image@sha256:1e8b199249d6d0ef3419ddc6eda2348d9fbdb10d350d3bb70aa98e87faa227c9 ${TEST_IMAGE}:trivyimage
